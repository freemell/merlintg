...
export class MerlinBridge {
  ...
  async bridgeSolanaToEvm(params, keypair, fromChainId, toChainId, normalizedToChain) {
    ...
    try {
      ...
      // Bungee Exchange uses /api/v1/bungee/quote endpoint
      const quoteUrl = `${this.socketApiUrl}/api/v1/bungee/quote?` + new URLSearchParams({
      ...
      // Bungee Exchange uses /api/v1/bungee/build-tx endpoint
